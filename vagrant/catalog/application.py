...
def showLanding():
    ...
    if 'username' not in login_session:
        return render_template(
            'publiclanding.html', categories=categories, latests=latests
        )
    else:
        return render_template(
            'landing.html', categories=categories,
...
def newCategory():
    ...
    if request.method == 'POST':
        ...
        return render_template('newCategory.html', user=login_session['email'])
...
def showCategory(category_id):
    ...
    if 'username' not in login_session:
        return render_template(
            'publiccategoryitems.html', category=category, items=items
        )
    elif creator.id == login_session['user_id']:
        return render_template(
            'categoryitems.html', category=category, items=items,
            is_creator=True, user=login_session['email']
        )
    else:
        return render_template(
            'categoryitems.html', category=category,
...
def editCategory(category_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'editCategory.html', category=toEditCategory,
...
def editItem(item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'edititem.html', item=toEditItem, user=login_session['email'])
